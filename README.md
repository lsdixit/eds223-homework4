# Determining optimal suitability in Exclusive Economic Zones (EEZ)
## EDS223 - Homework #4 Leela Dixit

Repository containing all code and output for homework 4, in class EDS 223 of the MEDS program - Geospatial Analysis and Remote Sensing.
This project focuses on developing a workflow to determing habitat suitability based on sea surface temperature and depth for species of Oysters, and condensing that workflow into a reproducible function for Red Abalone.
