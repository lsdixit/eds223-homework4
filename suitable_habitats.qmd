...
total_area <- zonal(suitable_cell_area, eez_rast, fun="sum", na.rm = TRUE)
knitr::kable(total_area, format = "html", col.names = c("Region ID", "Total Suitable Area (km)"), table.attr = 'data-quarto-disable-processing="true"') %>% 
  kableExtra::kable_styling(bootstrap_options = c("basic", "hover"), full_width = FALSE)
...
tm_shape(total_area) +
  tm_polygons(fill = "area",
              breaks = c(60000, 160000, 170000, 202000, 206000, Inf),
